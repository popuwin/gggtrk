    ...
    <div className="relative bg-[#F7F8FA] text-[#1A1A1A]">
      ...
      <main id="top" className="relative z-10">
        <section className="relative isolate z-10 flex min-h-screen items-center overflow-hidden pt-24">
          <img src={`${assetBase}images/hero-sprinters.png`} alt="Синий и белый Mercedes Sprinter" className="absolute inset-0 h-full w-full object-cover" />
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            <article className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_16px_36px_rgba(16,24,40,0.08)]">
              <div className="overflow-hidden rounded-xl">
                <img src={`${assetBase}images/blue-sprinter.png`} alt="Синий Sprinter" className="h-52 w-full object-cover transition duration-500 group-hover:scale-110" />
              </div>
            ...
            <article className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_16px_36px_rgba(16,24,40,0.08)]">
              <div className="overflow-hidden rounded-xl">
                <img src={`${assetBase}images/white-sprinter.png`} alt="Белый Sprinter" className="h-52 w-full object-cover transition duration-500 group-hover:scale-110" />
              </div>
